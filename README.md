...
- [x] Дизайн PageTitile comonent
- [x] Пагинация к слайдерам
...
- [x] Админка
- [x] !!! Хранение данных
- [x] m: Fix Активной ссылки в бурге меню
- [x] Скачивание файлов в лицензиях
- [x] Валидация feedbackform
- [x] Маска телефона <PhoneComponent/>
- [x] Вынести навигацию в компонент
- [x] Error Boundary
