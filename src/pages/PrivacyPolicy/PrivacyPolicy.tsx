                    ...
                    <div id="inputResult" className="container px-20">
                        ...
                        <div className="row mb-4">
                            <div className="col">
                                ...
                                <div className="descr">
                                    ...
                                    данных, предпринимаемые <span className="link mark owner-name-field" id="owner-name-value" data-scroll-to="#owner-name-field">ООО ЧОП «Инфосервис»</span> (далее&nbsp;— Оператор).
                                </div>
                                <div className="ol">
                                    <div className="li">
                                    ...
                                    <div className="li">
                                        ...
                                        которую Оператор может получить о&nbsp;посетителях веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://infoservice-agency</span>.
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="col">
                                ...
                                <div className="ol">
                                    ...
                                    <div className="li">
                                        ...
                                        их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://infoservice-agency</span>.
                                    </div>
                                    <div className="li">
                                    ...
                                    <div className="li">2.8. Персональные данные&nbsp;— любая информация,
                                        относящаяся прямо или косвенно к&nbsp;определенному или определяемому
                                        Пользователю веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://infoservice-agency</span>.
                                    </div>
                                    <div className="li">
                                    ...
                                    <div className="li">
                                        2.10. Пользователь&nbsp;— любой посетитель веб-сайта <span className="link mark owner-site-url-field" data-scroll-to="#owner-site-url-field">https://infoservice-agency</span>.
                                    </div>
                                    <div className="li">
                        ...
                        <div className="row mb-4">
                            <div className="col">
                                ...
                                <div className="ol">
                                    <div className="li" id="dMRXk">
                                        <table className="purpose-table">
                                            <tbody><tr>
                                                <th>Цель обработки</th>
                                                <td className="purpose-field"><span className="mark link">уточнение деталей заказа</span></td>
                                            </tr>
                                                <tr>
                                                    <th>Персональные данные</th>
                                                    <td className="data-field"><ul><li><span className="mark link">фамилия, имя, отчество</span></li><li><span className="mark link">номера телефонов</span></li></ul></td>
                                                </tr>
                                                <tr>
                                                    <th>Правовые основания</th>
                                                    <td className="legal-field"><ul><li><span className="mark link">Федеральный закон «Об&nbsp;информации, информационных технологиях и&nbsp;о&nbsp;защите информации» от&nbsp;27.07.2006&nbsp;N 149-ФЗ</span></li></ul></td>
                                                </tr>
                                                <tr>
                                                    <th>Виды обработки персональных данных</th>
                                                    <td className="types-field"><ul><li><span className="mark link">Сбор, запись, систематизация, накопление, хранение, уничтожение и&nbsp;обезличивание персональных данных</span></li></ul></td>
                                                </tr>
                                            </tbody></table>
                                    </div>
                            ...
                            <div className="col">
                                ...
                                <div className="ol">
                                    ...
                                    <div className="li">
                                        ...
                                        Оператору уведомление на&nbsp;адрес электронной почты Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">infoservice_2016@mail.ru</span>
                                    ...
                                    <div className="li">
                                        ...
                                        посредством электронной почты на&nbsp;электронный адрес Оператора <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">infoservice_2016@mail.ru</span>
                            ...
                            <div className="col">
                                ...
                                <div className="ol">
                                    <div className="li">
                                        ...
                                        к&nbsp;Оператору с&nbsp;помощью электронной почты <span className="link mark owner-email-field" data-scroll-to="#owner-email-field">infoservice_2016@mail.ru</span>.
                                    </div>
                                    <div className="li">
